...
from ..transforms import bbox2roi, bbox_mapping, merge_aug_bboxes
from ..bbox_nms import multiclass_nms#, ,merge_aug_masks, 
...
class BBoxTestMixin:
    ...
    def simple_test_bboxes(self,
        ...
        bbox_results = self._bbox_forward(x, rois, level=level)
